...
public final class TrackRemoveAction extends AbstractAction {

    private static final long serialVersionUID = 1L;
    private final CompositionExplorer compositionExplorer;

    public TrackRemoveAction(CompositionExplorer compositionExplorer) {
        this.compositionExplorer = Objects.requireNonNull(compositionExplorer);
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        compositionExplorer.removeTrack();
    }
}
