...
public final class TrackActivateAction extends AbstractAction {

    private static final long serialVersionUID = 1L;

    private final CompositionExplorer compositionExplorer;

    public TrackActivateAction(CompositionExplorer compositionExplorer) {
        this.compositionExplorer = Objects.requireNonNull(compositionExplorer);
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        compositionExplorer.activateSelectedTrack();
    }
}
