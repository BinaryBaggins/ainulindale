...
public class WorkspaceErrors {
    ...
    public static final ResultError TRACK_ALREADY_PRESENT = new ResultError(
        "Workspace.TrackAlreadyPresent"
    );

    public static final ResultError TRACK_NOT_FOUND = new ResultError(
        "Workspace.TrackNotFound"
    );

    public static final ResultError TRACK_NOT_VISIBLE = new ResultError(
        "Workspace.TrackNotVisible"
    );
